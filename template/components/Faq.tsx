  ...
  return (
    <details className="group py-4">
      <summary className="cursor-pointer list-none flex items-start gap-3 font-medium hover:text-zinc-600 dark:hover:text-zinc-300">
        <span className="text-zinc-300 dark:text-zinc-600 mt-0.5 shrink-0 transition-transform group-open:rotate-90">
          ›
        </span>
        <span>{q}</span>
      </summary>
      <div className="pl-6 pt-3 text-zinc-600 dark:text-zinc-400 leading-relaxed space-y-3 [&_strong]:text-zinc-800 dark:[&_strong]:text-zinc-200">
        {children}
      </div>
    </details>
  );
